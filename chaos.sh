...
#///////////////////////////////////////////////////////////////////////////////
#///////////////////////////////////////////////////////////////////////////////
#PERINGATAN : KESALAHAN ATAU KEJAHATAN ADALAH TANGGUNG JAWAB DARI PEMAKAI, GUNAKAN TOOLS DENGAN BIJAK
#JIKA ADA KESALAHAN DI TOOLS INI MOHON MAAF INI TOOLS SEDANG DALAM PERBAIKAN, SEKIAN TERIMA KASIH
chaos(){
      echo "           .-----. "
      sleep 0.03
      echo " \ ' /   _/    )/ "
...
get_chaos_angel="http://MRZofficial/api/MRZID.php?request=chaos"
mulai(){
...
#start
clear
echo "PERINGATAN : KESALAHAN ATAU KEJAHATAN ADALAH TANGGUNG JAWAB DARI PEMAKAI, GUNAKAN TOOLS DENGAN BIJAK"
echo "CODING PROGRAMING TOOLS BY MRZ ID :)"
echo "Lanjutkan?"
echo "y/n?"
read lanjutkan
if [ $lanjutkan = "y" ];then
    ...
    clear
    chaos
    echo Selamat datang di tools MRZ ID, Siapa nama anda? #tulisan keluar
